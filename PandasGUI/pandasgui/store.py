...
class PandasGuiDataFrameStore(PandasGuiStoreItem):
    ...
    def add_column(self, first: int, last: int):
        parent = QtCore.QModelIndex()
        self.dataframe_viewer.setUpdatesEnabled(False)
...
class PandasGuiStore:
    ...
    # Use this context to display a status message for a block.
    # self should be a PandasGuiStore or PandasGuiDataFrameStore
