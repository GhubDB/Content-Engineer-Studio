...
# Form implementation generated from reading ui file 'c:\Users\Me\Dropbox\Python\.git-rewrite\t\content_engineer_studio\ContentEngineerStudio\pqt_test_designs\main_window.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.central_stacked_widget.addWidget(self.analysis_suite)
        ...
        self.central_stacked_widget.addWidget(self.testing_suite)
        ...
        self.central_stacked_widget.addWidget(self.settings)
        ...
        self.central_stacked_widget.addWidget(self.faq)
        self.openExcel = QtWidgets.QWidget()
        self.openExcel.setObjectName("openExcel")
        self.central_stacked_widget.addWidget(self.openExcel)
        ...
        self.central_stacked_widget.addWidget(self.data_frame_viewer)
        self.gridLayout_6.addWidget(self.central_stacked_widget, 0, 0, 1, 1)
