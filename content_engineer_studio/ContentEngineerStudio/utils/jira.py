...
requests.packages.urllib3.disable_warnings(
    requests.packages.urllib3.exceptions.InsecureRequest
)
...
class Jira(object):
    __options = {"server": "<protocols>://<your.company.com>", "verify": False}
    ...
    def __str__(self):
        return "Jira(username = {}, password = {}, endpoint = {}".format(
            self.__username, self.__password, self.__options
        )
