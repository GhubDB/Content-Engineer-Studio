descriptors = [
    [
        "Ja, hätte besser gemacht werden können",
        "Nein, hätte nicht besser gemacht werden können",
    ],
    ["Bot hat Anliegen korrekt erkannt", "Bot hat Anliegen nicht korrekt erkannt"],
    [
        "Korrektes FAQ ausgespielt/Flow gestartet",
        "Ausgespieltes FAQ/Flow nicht korrekt",
    ],
